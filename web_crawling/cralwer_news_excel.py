...
file_path = f'C:/MyWorkspace/upload/사회_사건/사고뉴스_{d.year}_{d.month}_{d.day}.xlsx'
...
# 페이지 이동 (베스트셀러 페이지)
driver.get('https://news.naver.com/breakingnews/section/102/256')
...
# 포함하는 토플을 반환하는 함수입니다.
headers = ['이미지', '기사제목', '기사내용', '신문사', '날짜', '링크']
